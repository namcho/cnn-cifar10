...
'''
X = layers.Conv2D(filters = 32, kernel_size = (2,2), strides = (2,2), padding = 'valid', name = 'CONV2D_5',
...
X = layers.Conv2D(filters = 32, kernel_size = (3,3), strides = (1,1), padding = 'same', name = 'CONV2D_6',
                  kernel_regularizer=keras.regularizers.l2(0.001))(X)
X = layers.BatchNormalization(axis = -1, name = 'BN6_1')(X)
X = layers.Activation('relu')(X)
X = layers.BatchNormalization(axis = -1, name = 'BN6_2')(X)

X = layers.Conv2D(filters = 64, kernel_size = (3,3), strides = (1,1), padding = 'same', name = 'CONV2D_7',
                        kernel_regularizer=keras.regularizers.l2(0.001))(X)
X = layers.BatchNormalization(axis = -1, name = 'BN7_1')(X)
X = layers.Activation('relu')(X)
X = layers.BatchNormalization(axis = -1, name = 'BN7_2')(X)

X = layers.Conv2D(filters = 64, kernel_size = (3,3), strides = (2,2), padding = 'valid', name = 'CONV2D_8',
                        kernel_regularizer=keras.regularizers.l2(0.001))(X)
X = layers.BatchNormalization(axis = -1, name = 'BN8_1')(X)
X = layers.Activation('relu')(X)
X = layers.BatchNormalization(axis = -1, name = 'BN8_2')(X)
...
X = layers.Dense(units = 128, activation='relu', kernel_regularizer=keras.regularizers.l2(penalty))(X)
X = layers.Dropout(0.3)(X)
